...
namespace Loodon
{
    ...
    {
        //public string QEQueryText {get; set;}
        ...
        private void QueryEditor_Load(object sender, EventArgs e)
        {
            //HANDLES THE LINE NUMBERS
            //--------------------------------------------
            numberLabel.Height = richTextBox1.Height;
            numberLabel.Top = richTextBox1.Top;

            numberLabel.Font = new Font(richTextBox1.Font.FontFamily, richTextBox1.Font.Size);
            //--------------------------------------------

            //TabPages names handling
            //tabControl1.TabPages[0].Text = "Query " + (tabControl1.TabPages.Count).ToString();
        }
